  ...
  return (
    <div className="footer">
      <div className="container">
        <div className="row">
          <div className=" f-content col-11 col-sm-8 col-lg-8 mx-auto d-flex flex-column flex-sm-row justify-content-sm-between align-items-center">
            <div className="footer-logo d-flex flex-column justify-content-between gap-4 gap-sm-0">
            ...
            <div className="elements">
              <ul className="d-flex flex-column justify-content-between  text-center">
                <li>
                  <a href="#">About Us</a>
                </li>
                <li>
          ...
          <div className="f-content col-11 col-sm-3 col-lg-4 mx-auto d-flex justify-content-sm-end justify-content-center">
